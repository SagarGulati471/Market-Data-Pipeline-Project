...
```
 Finnhub WebSocket
        |
        v
 [ data_collector ]  -->  Kafka: market_data
        |
        v
 [   normalizer   ]  -->  Kafka: trades-normalized
        |
        v
 [ candle_builder ]  -->  Kafka: candles
        |
        v
 [  indicator_calculator  ]  -->  Kafka: indicators
        |
        v
 [ signal_generator ]  -->  Kafka: signals
        |
        v
 [ order_executor  ]  -->  Kafka: order-executor
        |
        v
   TimescaleDB
```
