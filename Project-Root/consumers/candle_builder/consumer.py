...
from .handler import make_handler, sweep_old_candle
...
async def main():
    ...
    consumer = KafkaConsumerService(
        ...
        dlt_topic=config.DEAD_LETTER_TOPIC_CANDLE_BUILDER,
        dlt_producer=dlt_producer,
    )

    sweeper_task = asyncio.create_task(sweep_old_candle(producer, db_pool))
